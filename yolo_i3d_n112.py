...
class I3D(torch.nn.Module):
    def __init__(self,
        ...
        self.avg_pool_n112 = torch.nn.AvgPool3d((2, 4, 4), (2, 1, 1)) # new
        ...
        self.maxPool3d_2x1x1_n112 = MaxPool3dTFPadding(kernel_size=(2, 1, 1), stride=(2, 1, 1), padding='SAME')        
        
    def forward(self, inp):
        out = inp
        out = self.maxPool3d_2x1x1_n112(inp) #new added

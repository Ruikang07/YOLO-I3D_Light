...
from yolo_i3d_s112 import I3D, Unit3Dpy, YOLO_3D_Bottom
from i3d_src.DataLoader_i3d_k400_DS2_s112_ge128 import RGB_jpg_train_Dataset, RGB_jpg_val_Dataset
        ...
        for i in range(len_train_loader):        
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'val':
                    ...
                    s1 = "i3d_top_s112_k400_DS2_ge128_f64_"+d_t+"_"
...
if __name__ == "__main__":    
    ...
    weight_i3d = 'weights/yolo_i3d_top_s112_k400_d2_f64_val_acc_0.6050.pth'
